...
<div class="body-wrap services inner">
	...
	<!-- Section 2 -->
	<div id="web-wordpress" class="container-wrap second">
		<div class="container left column">
			<small><i class="fa fa-wordpress" aria-hidden="true"></i> WordPress Websites</small>
			<h2>WordPress: A Database Solution</h2>			
			<p><a href="https://wordpress.org/" target="_blank">WordPress</a> is one of the most widely-used Content Management Systems (CMS) around the world. There are a few reasons for this. Here are a few:</p>
			<ul>
				<li>All content types (text, images, PDFs, etc.) are easily-managed.</li>
				<li>Create various user access permissions.</li>
				<li>Very extendable using plugins and pre-built themes.</li>
			</ul>
			<p>Each website is customized specifically to each client. Each design includes all applicable brand guidelines including colors, fonts and imagery.</p>			
		</div>
	</div>
	<!-- Section 3 -->
	<div id="web-html" class="container-wrap third">
		<div class="container left column">
	...
	<div id="email-mailchimp" class="container-wrap fourth">
		<div class="container left column">
			...
			<p>MailChimp is a robust email management system that is extremely user-friendly. Your HTML email template can be custom-built to integrate perfectly with MailChimp so you can create nearly any type of new content within your template at any time.</p>
		</div>
	</div>
	<!-- Section 4 -->
	<div id="email-campaign-monitor" class="container-wrap fifth">
		<div class="container left column">
			...
			<p>Campaign Monitor is another very user-friendly platform. HTML email templates can be customized for this platform as well, but with less available options to manage content types. Still a fantistic program, Campaign Monitor will easily suit the needs of the majority of users.</p>
		</div>
	</div>
</div>
