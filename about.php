...
<div class="body-wrap about inner">
	...
	<div id="personal" class="container-wrap second">
		<div class="container left column">
			...
			<p>I enjoy spending time with my dogs, I am addicted to Netflix and Amazon shows and keeping up with what's going on in the web development community.</p>
			<p>Keep up with me on <a href="https://www.instagram.com/jamesfrazier81/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i> Instagram</a> and <a href="https://www.facebook.com/jamesfrazier2.0" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a>.
		</div>
	</div>
</div>
