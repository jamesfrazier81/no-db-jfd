...
<div class="body-wrap home">
	...
	<div class="container-wrap first">
		<div class="container">
			<div class="caption-box">
				...
				<a href="/services" class="btn btn-blue">Learn More <i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
			</div>
		</div>
	</div>
	<!-- Section 2 -->
	...
	<div id="email" class="container-wrap third">
		<div class="container">
			...
			<ul>
				<li><a href="/services/#wordpress"><img src="/img/dist/logo-mailchimp-type.png" alt="MailChimp"></a></li>
				<li><a href="/services/#static"><?php include('includes/logo-campaign-monitor.php'); ?></a></li>
			</ul>
		</div>
	</div>
	<!-- Section 4 -->
	<div id="why" class="container-wrap fourth">
		<div class="container">
			...
			<a href="/about" class="btn btn-blue">Learn More <i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
		</div>
	</div>
</div>
